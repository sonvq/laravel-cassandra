<?php namespace novocast\Cassandra\Eloquent;

use Carbon\Carbon;
use DateTime;
use Illuminate\Database\Eloquent\Model as BaseModel;
use Illuminate\Database\Eloquent\Relations\Relation;
use novocast\Cassandra\Query\Builder as QueryBuilder;
use novocast\Cassandra\Relations\EmbedsMany;
use novocast\Cassandra\Relations\EmbedsOne;
use novocast\Cassandra\Relations\EmbedsOneOrMany;
...
abstract class Model extends BaseModel
{
     ...
     * @return \novocast\Cassandra\Relations\EmbedsMany
     */
     ...
     * @param  string  $foreignKey
     * @param  string  $relation
     * @return \novocast\Cassandra\Relations\EmbedsOne
     */
     ...
     *
     * @param  \novocast\Cassandra\Query\Builder $query
     * @return \novocast\Cassandra\Eloquent\Builder|static
     */
